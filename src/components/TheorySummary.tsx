...
import { Award, RefreshCw, Undo2, CheckCircle } from 'lucide-react';
...
export function TheorySummary({ 
    ...
    const progress = totalChapters > 0 ? (understoodCount / totalChapters) * 100 : 0;
        ...
        <div className="flex-grow flex items-center justify-center">
            <Card className="w-full max-w-md text-center bg-background/80 backdrop-blur-sm">
                <CardHeader>
                    ...
                    <CardTitle className="text-2xl">{isCompleted ? "Tuyệt vời! Bạn đã học hết lý thuyết!" : "Báo cáo tiến độ"}</CardTitle>
                ...
                <CardContent className="space-y-6">
                    <div className="grid grid-cols-2 gap-4 text-center">
                     ...
                     <div className="flex flex-col items-center space-y-2 pt-4">
                        ...
                        <span className="text-sm text-muted-foreground">({understoodCount} / {totalChapters} chương)</span>
                    </div>
                </CardContent>
